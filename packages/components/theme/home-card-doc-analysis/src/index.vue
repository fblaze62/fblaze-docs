<script setup lang="ts" name="HomeCardDocAnalysis">
...
import { useTeekConfig, usePosts } from "@teek/components/theme/config-provider";
import { TkPageCard } from "@teek/components/common/page-card";

defineOptions({ name: "HomeCardDocAnalysis" });
