<script setup lang="ts" name="HomeCardTag">
...
import { pageNumKey } from "@teek/components/theme/home-post";
import { useTeekConfig, usePagePath, usePosts, useTagColor } from "@teek/components/theme/config-provider";
...
defineOptions({ name: "HomeCardTag" });
