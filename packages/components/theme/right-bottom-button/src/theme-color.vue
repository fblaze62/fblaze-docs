<!-- 该文件为 @teek/components/theme-enhance/src/theme-color.vue 的非扩散版，代码逻辑完全一样 -->
<script setup lang="ts" name="ThemeColor">
import type { ThemeEnhance } from "@teek/config";
import type { ThemeColorOption } from "@teek/components/theme/theme-enhance";
...
import {
  ...
  useThemeColorList,
} from "@teek/components/theme/theme-enhance";
