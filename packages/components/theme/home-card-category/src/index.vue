<script setup lang="ts" name="HomeCardCategory">
...
import { pageNumKey } from "@teek/components/theme/home-post/src/home-post";
import { useTeekConfig, usePagePath, usePosts } from "@teek/components/theme/config-provider";
import { postDataUpdateSymbol } from "@teek/components/theme/home-main/src/home-main";
import { TkPageCard } from "@teek/components/common/page-card";

defineOptions({ name: "HomeCardCategory" });
