<script setup lang="ts" name="HomeCardTopArticle">
...
import { useTeekConfig, usePosts, useTagColor } from "@teek/components/theme/config-provider";
import { TkPageCard } from "@teek/components/common/page-card";
import { TkArticleTitle } from "@teek/components/theme/article-title";

defineOptions({ name: "HomeCardTopArticle" });
